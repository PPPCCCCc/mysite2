						...
						<div id="modifyForm">
							<form action="/mysite2/user?" method="post">
								...
								<div class="form-group">
									...
									<input type="password" id="input-pass" name="password" value="${requestScope.userVo.password }" placeholder="비밀번호를 입력하세요">
								</div>
								...
								<div class="form-group">
									...
									<input type="radio" id="rdo-male" name="gender" value="male" <c:if test="${requestScope.userVo.gender=='male'}">checked</c:if>> 
									
									<label for="rdo-female">여</label> 
									<input type="radio" id="rdo-female" name="gender" value="female" <c:if test="${requestScope.userVo.gender=='female'}">checked</c:if>> 
