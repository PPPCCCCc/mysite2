	...
	<div id="wrap">
		...
		<div id="container" class="clearfix">
			...
			<div id="content">
				...
				<div id="board">
					<div id="list">
						<form action="/mysite2/lct" method="get">
						...
						<table >
							...
							<tbody>
								<tr>
									<td>${boardVo.no }</td>
									<td class="text-left"><a href="/mysite2/lct?action=read&no=${boardVo.no }">${boardVo.title }</a></td>
									<td>${boardVo.name}</td>
									<td>${boardVo.hit}</td>
						...
						<a id="btn_write" href="/mysite2/lct?action=writeForm">글쓰기</a>
						</c:if>
					</div>
					<!-- //list -->
				</div>
